...
// check. https://gcc.gnu.org/onlinedocs/gcc-4.8.2/libstdc++/api/a01053_source.html
// line 2812-2813
...
#endif
// This is set by default, because we assume that compilers with no wchar_t support
...
// between the results, and passes userdata as the first parameter to each
// invocation, e.g. CATCH_REC_LIST_UD(f, x, a, b, c) evaluates to f(x, a), f(x, b),
// f(x, c)
...
#define INTERNAL_CATCH_REMOVE_PARENS_11_ARG(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, \
                                            _10)                                    \
    INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_10_ARG(          \
                                          _1, _2, _3, _4, _5, _6, _7, _8, _9, _10)

#define INTERNAL_CATCH_VA_NARGS_IMPL(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10,   \
                                     N, ...)                                        \
    N
...
#ifndef CATCH_CONFIG_TRADITIONAL_MSVC_PREPROCESSOR
#define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION(ClassName, Name,   \
                                                                 Tags, ...)         \
...
#define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_2(TestName, TestFunc, Name, Tags,    \
                                                 TmplList)                          \
    CATCH_INTERNAL_START_WARNINGS_SUPPRESSION                                       \
    CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                                        \
    CATCH_INTERNAL_SUPPRESS_UNUSED_TEMPLATE_WARNINGS                                \
...
/// characteristics so that we can account for it in the measurement. Implementations
/// of std::function with optimizations that aren't always applicable, like small
/// buffer optimizations, are not uncommon. This is effectively an implementation of
/// std::function without any such optimizations; it may be slow, but it is
/// consistently slow.
...
// There is another overload, in catch_assertionhandler.h/.cpp, that only takes a
// string and infers the Equals matcher (so the header does not mention matchers)
void handleExceptionMatchExpr(AssertionHandler& handler,
                              StringMatcher const& matcher,
                              StringRef const& matcherString)
{
...
struct Parser : ParserBase
{
        ...
        -> InternalParseResult override
    {
        ...
        // ParserInfo parseInfos[totalParsers]; // <-- this is what we really want to
        // do
...
void RunContext::assertionEnded(AssertionResult const& result)
{
    ...
    // because messages were made scoped and should be let to clear themselves out.
    static_cast<void>(
                      ...
                      SourceLineInfo const& _lineInfo)
{
    ...
    TestCaseInfo info(static_cast<std::string>(nameAndTags.name), _className, desc,
                      tags, _lineInfo);
...
#define REQUIRE_THAT(arg, matcher)                                                  \
    INTERNAL_CHECK_THAT("REQUIRE_THAT", matcher, Catch::ResultDisposition::Normal,  \
                        arg)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
