...
For the pad, solder the wires on a bit like you would an surface mount component.  It's a bit fiddly but will work fine with some patience.

![Pico USB - Soldered wires](./img/picoUSB3.jpg)

Finally, solder the wires onto a 3-pin header. It can be easy if you could the Pico and the header in place, and then solder the wires.
