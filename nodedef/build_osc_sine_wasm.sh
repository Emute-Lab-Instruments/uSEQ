...
EXPORTED_FUNCS+='_osc_sine_sample_rate_abi_version,'
...
EXPORTED_FUNCS+='_osc_sine_compute_at_sample_rate,'
EXPORTED_FUNCS+='_osc_sine_compute_fm,'
EXPORTED_FUNCS+='_osc_sine_compute_fm_at_sample_rate,'
