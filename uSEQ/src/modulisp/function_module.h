...
struct FunctionDescriptor
{
    ...
    FunctionDescriptor(const String& n, const String& m, BuiltinFunc f,
                       bool special = false)
    ...
    FunctionDescriptor(const String& n, const String& m, MethodFunc* f, void* inst,
                       bool special = false)
        : name(n), module(m), is_special_form(special), method_func(f),
          instance(inst)
    {
    }
};
