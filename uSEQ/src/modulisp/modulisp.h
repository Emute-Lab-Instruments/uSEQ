...
public:
    ...
    {
    public:
        Response(const Value& val)
            : value(val), error_type(ErrorType::NONE), line(0), column(0)
        {
        }
        ...
        // Get the type name (returns capitalized strings like "Integer", "Float",
        // "Symbol")
        ...
        bool is_error() const
        {
            return error_type != ErrorType::NONE || value.get_type_enum() == 14;
        }
        ...
        Response& set_error_type(ErrorType type)
        {
            error_type = type;
            return *this;
        }
        Response& set_error_message(const std::string& msg)
        {
            error_message = msg;
            return *this;
        }
        Response& set_location(int l, int c)
        {
            line   = l;
            column = c;
            return *this;
        }
        Response& set_suggestion(const std::string& s)
        {
            suggestion = s;
            return *this;
        }
        Response& add_did_you_mean(const std::string& s)
        {
            did_you_mean.push_back(s);
            return *this;
        }
        Response& add_example(const std::string& e)
        {
            examples.push_back(e);
            return *this;
        }
        Response& set_context_snippet(const std::string& c)
        {
            context_snippet = c;
            return *this;
        }
        Response& add_stack_frame(const std::string& f)
        {
            stack_trace.push_back(f);
            return *this;
        }
        Response& add_warning(const std::string& w)
        {
            warnings.push_back(w);
            return *this;
        }
        Response& set_detailed_error(const std::string& d)
        {
            detailed_error = d;
            return *this;
        }
    ...
    void register_deprecated(const std::string& old_name,
