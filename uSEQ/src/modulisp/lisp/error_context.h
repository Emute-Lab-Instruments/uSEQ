...
public:
    ...
    void report_undefined_symbol(const String& symbol_name, const String& code = "",
                                 int line = 0, int column = 0);
    void report_undefined_function(const String& function_name,
                                   const String& code = "", int line = 0,
                                   int column = 0);
    void report_arity_error(const String& function_name, int expected, int received);
    void report_type_error(const String& function_name, const String& expected_type,
                           const String& received_type, int arg_index = -1);
    void report_arithmetic_error(const String& message);
    void report_syntax_error(const String& message, const String& code = "",
                             int line = 0, int column = 0);
...
private:
    ...
    ErrorContext& ensure_error_context(ErrorCategory category,
