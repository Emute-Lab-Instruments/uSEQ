...
std::vector<double> find_zero_crossings(const Value& v, double start_time,
                                        double end_time);
...
// Threshold Analysis
std::vector<double> find_threshold_crossings(const Value& v, double threshold,
                                             double start_time, double end_time);
double get_next_threshold_crossing(const Value& v, double threshold,
                                   double from_time, bool rising_edge = true);

// Range Analysis
std::vector<std::pair<double, double>>
find_value_ranges(const Value& v, double min_val, double max_val, double start_time,
                  double end_time);
bool is_in_range(const Value& v, double min_val, double max_val, double at_time);
double get_time_in_range(const Value& v, double min_val, double max_val,
                         double start_time, double end_time);

// Extrema Analysis
std::vector<double> find_local_maxima(const Value& v, double start_time,
                                      double end_time);
std::vector<double> find_local_minima(const Value& v, double start_time,
                                      double end_time);
