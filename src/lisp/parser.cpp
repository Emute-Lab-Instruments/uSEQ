...
String uLispParser::unescape(String str)
{
    String result = "";
...
void uLispParser::skip_whitespace(String& s, int& ptr)
{
    while (isspace(s[ptr]))
    {
        ptr++;
...
bool uLispParser::is_symbol(String& s, int ptr)
{
    char ch = s[ptr];
    return (isdigit(ch) || isalpha(ch) || ispunct(ch)) && ch != '(' && ch != ')' && ch != '"' && ch != '\'';
}

bool uLispParser::is_comment(String& s, int ptr) { return s[ptr] == ';'; }
bool uLispParser::is_quote(String& s, int ptr) { return s[ptr] == '\''; }
bool uLispParser::is_list(String& s, int ptr) { return s[ptr] == '('; }
bool uLispParser::is_vector(String& s, int ptr) { return s[ptr] == '['; }
bool uLispParser::is_map(String& s, int ptr) { return s[ptr] == '{'; }
bool uLispParser::is_midinote(String& s, int ptr) { return s[ptr] == 'M'; }
