...
//     int lastIndexOf(const String& str) const;
//     int lastIndexOf(const String& str, unsigned int fromIndex) const;
//     String substr(unsigned int beginIndex) const { return substr(beginIndex, len); };
//     String substr(unsigned int beginIndex, unsigned int endIndex) const;
