...
- `uSEQ/src/firmware/i2c_network.{h,cpp}` — `I2CNetwork`: multi-module I2C communication (leader election, tempo sync, value broadcast)
...
5. `io.write_outputs(values)` — write to PWM / SPI DAC / digital pins.
